...
const PUBLIC_ROUTES = {
    ...
    '/xanrean/characters/admin-chaos': path.join(PUBLIC_DIR, 'xanrean', 'characters', 'character.html'),
    '/xanrean/characters/admin-order': path.join(PUBLIC_DIR, 'xanrean', 'characters', 'character.html'),
