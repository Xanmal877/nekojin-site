...
const PUBLIC_ROUTES = {
    ...
    '/xanrean/characters/saki': path.join(PUBLIC_DIR, 'xanrean', 'characters', 'saki.html'),
    '/xanrean/characters/admin-destruction': path.join(PUBLIC_DIR, 'xanrean', 'characters', 'saki.html'),
    '/xanrean/characters/tama': path.join(PUBLIC_DIR, 'xanrean', 'characters', 'tama.html'),
    '/xanrean/characters/admin-creation': path.join(PUBLIC_DIR, 'xanrean', 'characters', 'tama.html'),
