...
const PROVIDERS = {
  ...
  claude: {
    ...
    models: [
      { id: 'claude-opus-4-7', name: 'Claude Opus 4.7 ($5/$25 per 1M)', vision: true },
      { id: 'claude-opus-4-6', name: 'Claude Opus 4.6 ($5/$25 per 1M)', vision: true },
      { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6 ($3/$15 per 1M)', vision: true },
      { id: 'claude-sonnet-4-5', name: 'Claude Sonnet 4.5 ($3/$15 per 1M)', vision: true },
      { id: 'claude-haiku-4-5', name: 'Claude Haiku 4.5 ($1/$5 per 1M)', vision: true },
  ...
  openai: {
    ...
    models: [
      { id: 'gpt-5.5', name: 'GPT-5.5 ($5/$30 per 1M)', vision: true },
      { id: 'gpt-5.4', name: 'GPT-5.4 ($2.50/$15 per 1M)', vision: true },
      { id: 'gpt-5.4-mini', name: 'GPT-5.4 Mini ($0.75/$4.50 per 1M)', vision: true },
      { id: 'gpt-5', name: 'GPT-5 ($1.25/$10 per 1M)', vision: true },
      { id: 'gpt-5-mini', name: 'GPT-5 Mini ($0.25/$2 per 1M)', vision: true },
      { id: 'gpt-4.1', name: 'GPT-4.1 ($2/$8 per 1M)', vision: true },
      { id: 'gpt-4.1-mini', name: 'GPT-4.1 Mini ($0.40/$1.60 per 1M)', vision: true },
      { id: 'gpt-4.1-nano', name: 'GPT-4.1 Nano ($0.10/$0.40 per 1M)', vision: true },
      { id: 'gpt-4o', name: 'GPT-4o ($2.50/$10 per 1M)', vision: true },
      { id: 'gpt-4o-mini', name: 'GPT-4o Mini ($0.15/$0.60 per 1M)', vision: true },
      { id: 'o4-mini', name: 'o4 Mini ($1.10/$4.40 per 1M)', vision: false },
      { id: 'o3', name: 'o3 ($2/$8 per 1M)', vision: false },
      { id: 'custom', name: 'Custom model…', custom: true }
    ],
    defaultModel: 'gpt-5',
    maxTokensDefault: 4096,
  ...
  xai: {
    ...
    models: [
      { id: 'grok-4.3', name: 'Grok 4.3 ($1.25/$2.50 per 1M)', vision: true },
      { id: 'grok-4.20-0309-reasoning', name: 'Grok 4.20 Reasoning ($1.25/$2.50 per 1M)', vision: true },
      { id: 'grok-4.20-0309-non-reasoning', name: 'Grok 4.20 Non-Reasoning ($1.25/$2.50 per 1M)', vision: true },
      { id: 'grok-4.20-multi-agent-0309', name: 'Grok 4.20 Multi-Agent ($1.25/$2.50 per 1M)', vision: true },
      { id: 'custom', name: 'Custom model…', custom: true }
    ],
